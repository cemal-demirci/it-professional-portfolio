  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Number Base Converter</h1>
        <p className="text-gray-600 dark:text-gray-400">Convert between Binary, Decimal, Hex, and Octal</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 space-y-4">
        {[
          ...
          <div key={item.key} className="space-y-2">
            ...
            <input type="text" value={values[item.key]} onChange={(e) => convert(item.key, e.target.value)} placeholder={item.placeholder} className="input-field dark:bg-gray-700 dark:border-gray-600 dark:text-white font-mono" />
          </div>
        ))}
      </div>
    </div>
