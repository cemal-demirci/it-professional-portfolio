...
IMPORTANT: Return ONLY valid JSON, no markdown formatting, no code blocks, no extra text.`
  ...
  const getSentimentColor = (sentiment) => {
    const colors = {
      ...
      'Neutral': 'text-gray-400 bg-gray-50 bg-gray-700/50',
      'Mixed': 'text-yellow-400 bg-yellow-900/30'
    }
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className={`text-center space-y-2 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
        <h1 className="text-3xl font-bold text-white flex items-center justify-center gap-2">
          <Brain className="w-8 h-8 text-purple-400 animate-pulse-slow" />
          AI Text Analyzer
        </h1>
      ...
      {/* Quota Warning */}
      <div className={`bg-gradient-to-r from-purple-900/20 to-pink-900/20 border-l-4 border-purple-600 p-4 rounded-lg transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '100ms' }}>
      ...
      <div className={`bg-gray-800 rounded-xl p-6 border border-gray-700 space-y-4 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
        ...
        <textarea
          ...
          className="textarea-field min-h-[200px] bg-gray-700 border-gray-600 text-white"
        />
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {Object.entries(analysis.statistics).map(([key, value]) => (
                  <div key={key} className="p-3 bg-gray-50 bg-gray-700/50 rounded-lg">
              ...
              <>
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-purple-900/30 rounded-lg">
                      <div className="text-sm text-purple-400 mb-2">Detected Tone</div>
                      <div className="flex flex-wrap gap-2">
                        {aiAnalysis.sentiment.tone.map((t, i) => (
                          <span key={i} className="px-2 py-1 bg-purple-800 text-purple-200 text-xs rounded-full">
                            {t}
                          </span>
                        ))}
                      </div>
                  ...
                  {aiAnalysis.sentiment.explanation && (
                    <div className="mt-3 p-3 bg-gray-50 bg-gray-700/50 rounded-lg">
                      <p className="text-sm text-gray-300">{aiAnalysis.sentiment.explanation}</p>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                    <div className="p-3 bg-blue-900/30 rounded-lg">
                      <div className="text-xs text-blue-400 mb-1">Clarity</div>
                      <div className="text-2xl font-bold text-blue-300">{aiAnalysis.quality.clarity}/10</div>
                    </div>
                    <div className="p-3 bg-green-900/30 rounded-lg">
                      <div className="text-xs text-green-400 mb-1">Coherence</div>
                      <div className="text-2xl font-bold text-green-300">{aiAnalysis.quality.coherence}/10</div>
                    </div>
                    <div className="p-3 bg-purple-900/30 rounded-lg">
                      <div className="text-xs text-purple-400 mb-1">Engagement</div>
                      <div className="text-2xl font-bold text-purple-300">{aiAnalysis.quality.engagement}/10</div>
                    </div>
                    <div className="p-3 bg-gradient-to-br from-purple-100 from-purple-900/40 to-pink-900/40 rounded-lg">
                      <div className="text-xs text-purple-400 mb-1">Overall</div>
                      <div className="text-2xl font-bold text-purple-300">{aiAnalysis.quality.overallScore}/10</div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-green-900/30 rounded-lg">
                      <div className="text-sm font-semibold text-green-300 mb-2">✓ Strengths</div>
                    ...
                    <div className="p-4 bg-yellow-900/30 rounded-lg">
                      <div className="text-sm font-semibold text-yellow-300 mb-2">⚠ Areas to Improve</div>
                      <ul className="space-y-1">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {aiAnalysis.suggestions.map((suggestion, i) => (
                      <div key={i} className="p-3 bg-purple-900/30 rounded-lg flex items-start gap-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {aiAnalysis.keyThemes.map((theme, i) => (
                        <span key={i} className="px-3 py-1 bg-primary-900/30 text-primary-300 rounded-full text-sm font-medium">
                          {theme}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="p-3 bg-gray-50 bg-gray-700/50 rounded-lg">
                      <p className="text-sm text-gray-300 mb-2">{aiAnalysis.writingStyle}</p>
            ...
            <div>
              ...
              <div className="p-4 bg-gradient-to-br from-blue-900/30 to-indigo-900/30 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm text-blue-400 mb-1">Flesch Reading Ease</div>
                    <div className="text-3xl font-bold text-blue-300">
                      {analysis.readability.score}
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm text-blue-400 mb-1">Difficulty Level</div>
                    <div className="text-lg font-semibold text-blue-300">
                      {analysis.readability.level}
                    </div>
                  </div>
                </div>
                <div className="mt-3 w-full bg-gray-200 bg-gray-700 rounded-full h-2">
                  <div
      ...
      <div className={`bg-gray-800 rounded-xl p-6 border border-gray-700 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '400ms' }}>
        <h3 className="font-semibold text-white mb-3">About This Tool</h3>
        <div className="space-y-2 text-sm text-gray-400">
          <p>
            <strong className="text-purple-400">🤖 AI-Powered Analysis:</strong> Uses Cemal AI to provide advanced sentiment analysis, quality scoring, and personalized writing suggestions.
          </p>
          <p>
            <strong className="text-white">Sentiment Analysis:</strong> AI identifies emotional tone, confidence level, and writing emotions.
          </p>
          <p>
            <strong className="text-white">Quality Assessment:</strong> Evaluates clarity, coherence, engagement, and provides actionable feedback.
          </p>
          <p>
            <strong className="text-white">Writing Suggestions:</strong> AI-generated recommendations to improve your writing.
          </p>
          <p>
            <strong className="text-white">Readability Score:</strong> Based on Flesch Reading Ease formula.
          </p>
        </div>
      </div>
    </div>
