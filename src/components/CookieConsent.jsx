...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-up">
      <div className="bg-gray-800 border-t-2 border-primary-600 shadow-2xl">
        <div className="max-w-6xl mx-auto p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {showDetails && (
                <div className="bg-gray-50 bg-gray-700/50 rounded-lg p-4 mb-4 space-y-3">
                  <div className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-white text-sm">{t(language, 'cookie.necessary')}</h4>
                  ...
                  <div className="flex items-start gap-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <div>
                        <h4 className="font-semibold text-white text-sm">{t(language, 'cookie.analytics')}</h4>
                        <p className="text-xs text-gray-400">
                  ...
                  <div className="flex items-start gap-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <div>
                        <h4 className="font-semibold text-white text-sm">{t(language, 'cookie.preferences')}</h4>
                        <p className="text-xs text-gray-400">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gray-200 bg-gray-700 text-white rounded-lg hover:hover:bg-gray-600 font-medium text-sm flex items-center gap-2 transition-all"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 text-gray-400 hover:hover:text-white font-medium text-sm transition-all"
                >
            ...
            <button
              onClick={handleReject}
              className="flex-shrink-0 text-gray-500 hover:text-gray-700 hover:text-gray-200"
              title="Reject & Close"
            >
              <X className="w-5 h-5" />
            </button>
