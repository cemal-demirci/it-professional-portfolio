  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-gray-800 rounded-xl p-6 border space-y-4">
        <textarea value={eventLog} onChange={(e) => setEventLog(e.target.value)} placeholder="Paste Evo III event logs..." className="textarea-field min-h-[300px] font-mono text-sm bg-gray-700" />
