    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-800 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-blue-300">Prompt Length</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-800 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-purple-300">Generation Time</span>
          </div>
      ...
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 space-y-4">
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-300">Script Type</label>
          <select
            value={scriptType}
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-300">Ne yapmak istiyorsun?</label>
          <textarea
            value={prompt}
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-300">Example Prompts</label>
      ...
      {result && (
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 space-y-4">
          ...
          <div className="p-4 bg-gray-950 rounded-lg overflow-x-auto">
