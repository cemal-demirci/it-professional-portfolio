...
const RemoteViewer = ({ onBack }) => {
  ...
  if (!connected && !connecting) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white from-gray-900 to-gray-900 flex items-center justify-center py-8">
        <div className="max-w-md w-full px-4">
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Connect to Computer</h2>
              <p className="text-gray-400">Enter the session code from the host</p>
            </div>
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-600 rounded-lg bg-gray-700 text-white font-mono text-lg"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={6}
                  className="w-full px-4 py-3 border border-gray-600 rounded-lg bg-gray-700 text-white font-mono text-lg tracking-wider text-center"
                />
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <div className="bg-gray-800 rounded-2xl shadow-xl p-6">
              <h2 className="text-2xl font-bold text-white mb-6">Remote Screen</h2>
              ...
              {messages.map((msg, i) => (
                <div key={i} className={`flex ${msg.from === 'viewer' ? 'justify-end' : msg.from === 'system' ? 'justify-center' : 'justify-start'}`}>
                  <div className={`px-4 py-2 rounded-lg max-w-xs ${
                    ...
                    msg.from === 'system' ? 'bg-green-900/30 text-green-300 text-xs font-semibold' :
